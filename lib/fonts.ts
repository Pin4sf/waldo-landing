...
export const sfProRounded = localFont({
  src: [
    { path: "../public/fonts/SF-Pro-Rounded-Thin.woff2", weight: "100", style: "normal" },
    { path: "../public/fonts/SF-Pro-Rounded-Ultralight.woff2", weight: "200", style: "normal" },
    ...
    { path: "../public/fonts/SF-Pro-Rounded-Heavy.woff2", weight: "800", style: "normal" },
    { path: "../public/fonts/SF-Pro-Rounded-Black.woff2", weight: "900", style: "normal" },
  ],
  variable: "--font-body",
  display: "swap",
});
