  ...
  return (
    ...
    >
      <div className="flex flex-col gap-[32.4px] items-start">
        ...
        <p className="text-[#1a1a1a]" style={{ fontFamily: "var(--font-headline)", fontSize: "18.876px", lineHeight: 1.1, width: "325.62px", whiteSpace: "pre-wrap" }}>{body}</p>
      </div>
  ...
  return (
    <section className="flex flex-col gap-[70px] items-center py-[90px] w-full" style={{ borderRadius: "30px" }}>
      ...
      <div className="relative shrink-0" style={{ height: "562px", width: "1004px" }}>
        ...
        <div className="absolute flex items-center justify-center" style={{ height: "538.752px", left: "446px", top: "15px", width: "498.469px" }}>
        ...
        <div className="absolute flex items-center justify-center" style={{ height: "546.077px", left: "43.97px", top: "7.96px", width: "507.436px" }}>
        ...
        <div
          ...
          style={{ left: "50%", top: "50%", transform: "translate(-50%, -50%)", padding: "55.793px", borderRadius: "22.687px" }}
        >
          <Image src={vectorBrief} alt="" width={112} height={87} unoptimized />
          <div
            className="text-[#1a1a1a]"
            style={{ fontFamily: "var(--font-headline)", fontSize: "26.435px", lineHeight: 1.1, width: "336.414px", whiteSpace: "pre-wrap" }}
          >
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-body)", fontVariationSettings: "'opsz' 14", fontStyle: "italic", fontSize: "16.738px", lineHeight: 1.3 }}
          >
      ...
      <div className="flex flex-col gap-[40px] items-center w-full">
        <h2 className="text-[#1a1a1a] text-[48px] text-center" style={{ fontFamily: "var(--font-headline)", lineHeight: 1.1 }}>
          With Waldo, this is what{" "}<br />you wake up to instead.
        </h2>
